    ...
    <div className="relative overflow-hidden px-5 lg:px-20 h-screen max-lg:h-full text-white">
      ...
      <div className="flex max-lg:flex-col justify-between lg:items-center h-full max-lg:pt-36">
        <div className="relative z-10">
          ...
          <p className="py-2 leading-[1.5]">At Yellow Panther we dare to think differently. We create state of the art products which push <br /> boundaries and inspire users. Our expert team of designers and developers build <br /> immersive, beautiful and streamlined digital products.</p>
        </div>
