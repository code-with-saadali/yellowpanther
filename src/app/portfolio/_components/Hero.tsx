...
const Hero = () => {
  ...
  return (
    <div className="relative overflow-hidden px-5 lg:px-20 h-[90vh] max-lg:h-full text-white">
      <AnimatedBackground />
      ...
      <div className="flex max-lg:flex-col justify-between lg:items-center h-full max-lg:pt-36">
        <div className="relative z-10">
          ...
          <p className="py-2 leading-[1.5]">We bring your project to life by combining wild creativity and boundless technology. Here&apos;s a <br /> snapshot of our work.</p>
        </div>
